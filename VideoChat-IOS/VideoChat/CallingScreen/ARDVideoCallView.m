...
@implementation ARDVideoCallView {
    ...
    /*调试信息*/
    UIView  *debugView;
    UILabel *debugSystemStatsLabel;
    UILabel *debugConnStatsLabel;
    UILabel *debugVideoSendLabel;
    UILabel *debugVideoReceiveLabel;
    UILabel *debugAudioSendLabel;
    UILabel *debugAudioReceiveLabel;
...
@synthesize session;
@synthesize preLayer;
@synthesize systemStatsLabel = debugSystemStatsLabel;
@synthesize connStatsLabel = debugConnStatsLabel;
@synthesize videoSendLabel = debugVideoSendLabel;
@synthesize videoReceiveLabel = debugVideoReceiveLabel;
@synthesize audioSendLabel = debugAudioSendLabel;
@synthesize audioReceiveLabel = debugAudioReceiveLabel;

-(void)setARDVideoCallingMode:(enum ARDVideoCallingMode) new_mode
{
    self.mode = new_mode;
    /*切换呼叫模式*/
    NSLog(@"setARDVideoCallingMode(sender = page)");
    [self layoutSubviews];
...
- (void) onButtonUpInSide:(id) sender
{
    ...
    {
        [_delegate videoCallViewDidSelectContacts:button.selected];
    }
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame])
    {
        ...
        selectContactButton.enabled = YES;
        ...
        selectContactButtonLabel.text = NSLocalizedString(@"Debug", @"");
    ...
    debugSystemStatsLabel = [[UILabel alloc] initWithFrame:CGRectZero] ;
    debugConnStatsLabel = [[UILabel alloc] initWithFrame:CGRectZero];
    debugVideoSendLabel = [[UILabel alloc] initWithFrame:CGRectZero];
    debugVideoReceiveLabel = [[UILabel alloc] initWithFrame:CGRectZero] ;
    debugAudioSendLabel = [[UILabel alloc] initWithFrame:CGRectZero];
    debugAudioReceiveLabel = [[UILabel alloc] initWithFrame:CGRectZero];
            ...
            for (int i = 0 ; i < kNumberOfPages ; i++)
            {
                ...
                }else if(i == 1)
                {
                    ...
                    if(debugView)
                    {
                        ...
                        [debugSystemStatsLabel setBackgroundColor: [UIColor clearColor]] ;
                        debugSystemStatsLabel.font = [UIFont systemFontOfSize:12];
                        [debugSystemStatsLabel setAlpha:0.9f];
                        // set some label properties
                        [debugSystemStatsLabel setTextAlignment: NSTextAlignmentCenter] ;
                        [debugSystemStatsLabel setTextColor: [UIColor whiteColor]] ;
                        CGSize fontSize = [debugSystemStatsLabel.text sizeWithFont:font];
                        debugSystemStatsLabel.frame = CGRectMake(0.0f,0.0f,fontSize.width,fontSize.height);
                        
                        debug_height += fontSize.height/2;
                    
                        debugSystemStatsLabel.center = CGPointMake(0, debug_height);
                        [debugView addSubview:debugSystemStatsLabel];
                        
                        [debugConnStatsLabel setBackgroundColor: [UIColor clearColor]] ;
                        debugConnStatsLabel.font = [UIFont systemFontOfSize:12];
                        [debugConnStatsLabel setAlpha:0.9f];
                        // set some label properties
                        [debugConnStatsLabel setTextAlignment:NSTextAlignmentCenter] ;
                        [debugConnStatsLabel setTextColor: [UIColor whiteColor]] ;
                        fontSize = [debugConnStatsLabel.text sizeWithFont:font];
                        debugConnStatsLabel.frame = CGRectMake(0.0f,0.0f,fontSize.width,fontSize.height);
                        debug_height += fontSize.height/2;
                        debugConnStatsLabel.center = CGPointMake(0, debug_height);
                        [debugView addSubview:debugConnStatsLabel];
                    
                        [debugVideoSendLabel setBackgroundColor: [UIColor clearColor]] ;
                        debugVideoSendLabel.font = [UIFont systemFontOfSize:12];
                        [debugVideoSendLabel setAlpha:0.9f];
                        // set some label properties
                        [debugVideoSendLabel setTextAlignment:NSTextAlignmentCenter] ;
                        [debugVideoSendLabel setTextColor: [UIColor whiteColor]] ;
                        fontSize = [debugVideoSendLabel.text sizeWithFont:font];
                        debugVideoSendLabel.frame = CGRectMake(0.0f,0.0f,fontSize.width,fontSize.height);
                        debug_height += fontSize.height/2;
                        debugVideoSendLabel.center = CGPointMake(0, debug_height);
                        [debugView addSubview:debugVideoSendLabel];
                        
                        [debugVideoReceiveLabel setBackgroundColor: [UIColor clearColor]] ;
                        debugVideoReceiveLabel.font = [UIFont systemFontOfSize:12];
                        [debugVideoReceiveLabel setAlpha:0.9f];
                        // set some label properties
                        [debugVideoReceiveLabel setTextAlignment: NSTextAlignmentCenter] ;
                        [debugVideoReceiveLabel setTextColor: [UIColor whiteColor]] ;
                        fontSize = [debugVideoReceiveLabel.text sizeWithFont:font];
                        debugVideoReceiveLabel.frame = CGRectMake(0.0f,0.0f,fontSize.width,fontSize.height);
                        debug_height += fontSize.height/2;
                        debugVideoReceiveLabel.center = CGPointMake(0, debug_height);
                        
                        [debugView addSubview:debugVideoReceiveLabel];
                        
                        [debugAudioSendLabel setBackgroundColor: [UIColor clearColor]] ;
                        debugAudioSendLabel.font = [UIFont systemFontOfSize:12];
                        [debugAudioSendLabel setAlpha:0.9f];
                        // set some label properties
                        [debugAudioSendLabel setTextAlignment: NSTextAlignmentCenter] ;
                        [debugAudioSendLabel setTextColor: [UIColor whiteColor]] ;
                        fontSize = [debugAudioSendLabel.text sizeWithFont:font];
                        debugAudioSendLabel.frame = CGRectMake(0.0f,0.0f,fontSize.width,fontSize.height);
                        debug_height += fontSize.height/2;
                        debugAudioSendLabel.center = CGPointMake(0, debug_height);
                        [debugView addSubview:debugAudioSendLabel];
                        
                        [debugAudioReceiveLabel setBackgroundColor: [UIColor clearColor]] ;
                        debugAudioReceiveLabel.font = [UIFont systemFontOfSize:12];
                        [debugAudioReceiveLabel setAlpha:0.9f];
                        // set some label properties
                        [debugAudioReceiveLabel setTextAlignment: NSTextAlignmentCenter] ;
                        [debugAudioReceiveLabel setTextColor: [UIColor whiteColor]] ;
                        fontSize = [debugAudioReceiveLabel.text sizeWithFont:font];
                        debugAudioReceiveLabel.frame = CGRectMake(0.0f,0.0f,fontSize.width,fontSize.height);
                        debug_height += fontSize.height/2;
                        debugAudioReceiveLabel.center = CGPointMake(0, debug_height);
                        [debugView addSubview:debugAudioReceiveLabel];
